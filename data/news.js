// Placeholder press/journal entries - original, in-brand copy.
module.exports = [
  {
    slug: 'umoya-wellness-spa-now-open-south-salt-lake',
    title: 'Umoya Wellness Spa Now Open in South Salt Lake',
    date: '2026-04-02',
    excerpt:
      'Founder Cheryl Johnson, RN-BSN-FAACM, brings a clinical, consultation-first approach to body contouring and medical wellness to South Salt Lake with the opening of Umoya Wellness Spa.',
    body: [
      ...
      'Umoya\'s opening lineup includes T-Shape 2 body contouring, RN-guided weight-loss support, and aesthetic treatments. Appointments are available Tuesday through Sunday, and every service is performed or overseen by a registered nurse.',
    ],
  },
  {
    slug: 't-shape-2-body-contouring-explained',
    title: 'What Makes T-Shape 2 Different From Other Body Contouring Systems',
    date: '2026-04-18',
    excerpt:
      'A closer look at the Italian-engineered technology behind our flagship treatment, and why zero downtime doesn\'t mean compromised results.',
    body: [
      'Body contouring has a crowded field of devices and acronyms, and it is fair for clients to ask what actually sets one system apart from another. At Umoya, T-Shape 2 is the flagship treatment, and the honest answer is that the difference comes down to engineering and how the technology is applied, not marketing.',
      'T-Shape 2 is an Italian-engineered system that combines multiple energy modalities in a single session, allowing a session to address skin tightening, circulation, and fat reduction together rather than requiring separate devices and separate appointments for each concern.',
      'Because the treatment works with the body\'s own processes rather than through invasive means, sessions require zero downtime. Clients typically resume normal activity immediately, which is a meaningful difference from surgical or more aggressive non-surgical alternatives that carry recovery windows.',
      'As with every service at Umoya, T-Shape 2 sessions begin with a consultation so Cheryl Johnson, RN-BSN-FAACM, can assess whether the treatment is genuinely the right fit for a client\'s goals before any session is booked. Results and the number of sessions needed vary by individual, which is why that first conversation matters more than the device itself.',
    ],
  },
  {
  ...
  {
    slug: 'five-questions-before-your-first-med-spa-consultation',
    title: 'Five Questions to Ask Before Your First Med Spa Consultation',
    date: '2026-05-22',
    excerpt:
      'Not all med spa visits are created equal. Here\'s what an honest, consultation-first practice should look like, and what to ask before you book.',
    body: [
      'The med spa industry has grown quickly, and quality varies widely between practices. Before booking a first consultation anywhere, including at Umoya, here are five questions worth asking to understand what kind of care you are actually getting.',
