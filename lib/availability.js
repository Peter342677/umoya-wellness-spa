...
// data/site.js's hours (Tuesday-Saturday 8:30am-4pm, Sunday 2-7pm, Monday
// closed).
const BUSINESS_HOURS = {
  1: null,
  2: { startHour: 8, startMinute: 30, endHour: 16, endMinute: 0 },
  3: { startHour: 8, startMinute: 30, endHour: 16, endMinute: 0 },
  4: { startHour: 8, startMinute: 30, endHour: 16, endMinute: 0 },
  5: { startHour: 8, startMinute: 30, endHour: 16, endMinute: 0 },
  6: { startHour: 8, startMinute: 30, endHour: 16, endMinute: 0 },
  7: { startHour: 14, startMinute: 0, endHour: 19, endMinute: 0 },
};
...
async function getAvailableSlots(dateStr, durationMinutes) {
  ...
  const dayStart = date.set({ hour: hours.startHour, minute: hours.startMinute, second: 0, millisecond: 0 });
  const dayEnd = date.set({ hour: hours.endHour, minute: hours.endMinute, second: 0, millisecond: 0 });
